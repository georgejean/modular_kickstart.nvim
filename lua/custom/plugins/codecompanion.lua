    ...
    adapters = {
      mistral = function()
        return require('codecompanion.adapters').extend('mistral', {
          ...
          env = {
            ...
            api_key = 'cmd:disp-sec.sh CODESTRAL_API_KEY',
      ...
      gemini = function()
        return require('codecompanion.adapters').extend('gemini', {
          env = {
            api_key = 'cmd:disp-sec.sh GEMINI_API_KEY',
          },
          schema = {
            model = {
      ...
      deepseek = function()
        return require('codecompanion.adapters').extend('deepseek', {
          env = {
            api_key = 'cmd:disp-sec.sh DEEPSEEK_API_KEY',
          },
          schema = {
            model = {
      ...
      together = function()
        return require('codecompanion.adapters').extend('openai_compatible', {
          env = {
            ...
            api_key = 'cmd:disp-sec.sh TOGETHER_API_KEY',
      ...
      groq = function()
        return require('codecompanion.adapters').extend('openai_compatible', {
          env = {
            ...
            api_key = 'cmd:disp-sec.sh GROQ_API_KEY',
            -- chat_url = '/v1/chat/completions', -- optional: default value, override if different
            models_endpoint = '/v1/models', -- optional: attaches to the end of the URL to form the endpoint to retrieve models
          },
          schema = {
      ...
      tavily = function()
        return require('codecompanion.adapters').extend('tavily', {
          env = {
            api_key = 'cmd:disp-sec.sh TAVILY_API_KEY',
          },
        })
      end,
      qwen = function()
      ...
      githubmodels = function()
        return require('codecompanion.adapters').extend('githubmodels', {
          env = {
            api_key = 'cmd:disp-sec.sh GITHUB_TOKEN',
          },
          schema = {
            model = {
              default = 'gpt-4.1',
